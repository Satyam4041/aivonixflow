...
const steps = [
  {
    ...
    icon: Search,
    timeframe: "Days 1 – 3",
    deliverables: ["Full Workflow Bottleneck Audit", "Architecture Blueprint", "Costed ROI Estimate"],
  ...
  },
  {
    ...
    icon: Cpu,
    timeframe: "Days 4 – 10",
    deliverables: ["Custom AI Agent Prompts & Guards", "Bidirectional CRM Connectors", "Retry & Failover Handling"],
  ...
  },
  {
    ...
    description: "We cut over in stages so the old process stays available until the new one is confirmed correct. Leads, invoices and inquiries are then triaged automatically.",
    icon: Zap,
  ...
  },
  {
    ...
    description: "Monitoring watches runtime health and surfaces failures rather than hiding them. Rules and prompts get revised as real outcomes come in.",
    icon: LineChart,
    timeframe: "Ongoing Evolution",
    deliverables: ["24/7 Automated Error Triage", "Quarterly Model Upgrades", "Capacity Reviewed as Volume Grows"],
