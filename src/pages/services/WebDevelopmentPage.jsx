  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="flex items-center gap-2 text-xs text-slate-400 mb-8">
        ...
        <span>/</span>
        <span className="text-brand-cyan font-medium">Web Development</span>
      </div>
      ...
      <div className="glass-card rounded-3xl p-8 sm:p-12 border border-white/10 mb-12 relative overflow-hidden">
        ...
        <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full glass-pill border border-white/10 text-xs font-medium text-brand-cyan mb-6">
          ...
          <span>High-Performance Digital Products</span>
        </div>

        <h1 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight font-heading max-w-3xl mb-6">
          Websites Built To <span className="text-gradient">Convert & Captivate</span>
        </h1>

        <p className="text-base sm:text-lg text-slate-400 max-w-2xl leading-relaxed mb-8">
          Speed, aesthetics, and fluid micro-interactions. We engineer ultra-responsive web applications and high-ticket marketing sites that rank high and convert effortlessly.
        </p>
        ...
        <div className="flex flex-wrap gap-4">
          ...
          >
            ...
            <span>Launch Your Next Site</span>
          </Link>
          <Link
            to="/services"
        ...
        {[
          {
            ...
            desc: "Optimized asset pipelines, static site generation, and edge caching for 99+ Lighthouse performance.",
          },
          {
            title: "GSAP & Framer Motion",
            desc: "Fluid scroll triggers, interactive 3D ribbons, and micro-animations that make your brand memorable.",
          },
          {
            title: "SEO & Conversion Architecture",
            desc: "Structured data, semantic hierarchy, and conversion-focused UI funnels that turn visitors into pipeline.",
          },
        ].map((item) => (
